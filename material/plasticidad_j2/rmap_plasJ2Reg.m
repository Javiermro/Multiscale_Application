function [ct,sigma_new,eps_new,hvar_new,aux_var] = rmap_plasJ2Reg(...
   ...
   switch tita
      case 0
         ...
         if e_DatMatSet.young~=0
            %H = -Sigmau^2/2/E/Gf*h;
            e_DatMatSet.hba = -e_DatMatSet.ftult^2/2/e_DatMatSet.gfv*hElemReg;
         else
            e_DatMatSet.hba = 0;
         end
         [ct,sigma_new,eps_new,hvar_new,aux_var] = RMapDanoSoloTraccion(eps_new,hvar_old,...
            e_DatMatSet,e_VG);
      case 1
         % Exponencial         
