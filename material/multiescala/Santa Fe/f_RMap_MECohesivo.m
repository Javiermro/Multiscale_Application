...
function KT = f_MatGlobal(c_CT,e_VarAux,e_DatSet,e_VG)
      ...
      for iSet = 1:nSet
         ...
         switch eltype
            case {2,4,8,20}
               %Se está considerando que en los elementos cuadrangulares 20 y 23, en los PGs arriba del 4 
               %vienen con pesos impuestos nulos. Por lo tanto únicamente se hace la integración de los 
               %valores que están sobre esos 4PGs.
