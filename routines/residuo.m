...
%Expresión completa del residuo (no se conoce Fint(doff))
...
%actualiza en cada iteración al calcular las Fint en la iter i, quiere decir que los residuos sobre
